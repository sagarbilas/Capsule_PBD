...
//----------- for Torso Dense Crowd ------- END ----------------------------------------------
  ...
  function computerClearanceForAgent(capsule_entity, normalized_velocity_2, closest_in_right, closest_in_left,scenario_type)
  {
      ...
      //   console.log(" if ");
      // }else{
      //   clearance = perpendicularDistance_right + perpendicularDistance_left - 3 * capsule_entity.radius; 
      //   console.log(" else: ");
      // }
  ...
  { 
    ...
    let cross_width = (dist_tip_to_base/2) + RADIUS;
      ...
      {
        let cosValue = ( (clearance - 1 * capsule.radius) / ( 2 * cross_width ));
      ...
      else if( (distToActivateOrientationConstraint < (cross_width + 2) ) && (clearance - capsule.radius <= 0) )
      {
        ...
        // capsule.vx = 0.02 * capsule.vx; 
        // capsule.vz = 0.02 * capsule.vz; 
