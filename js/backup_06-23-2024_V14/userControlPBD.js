...
return [closest_in_left,  closest_in_right, distToActivateOrientationConstraint, activate_orientation]            
  ...
  function computeClearanceForAgent(capsule_entity, normalized_velocity_2, closest_in_right, closest_in_left, object_type_in_both_sides)
  {
    ...
    // Create vector from capsule position to the point
    const vectorToclosest_in_right_2 = new THREE.Vector3().subVectors(closest_in_right_2, cur_position);  

    let velocity_vec = new THREE.Vector3(capsule_entity.vx, 0, capsule_entity.vz);
    let vel_direction = new THREE.Vector3(capsule_entity.vx, 0, capsule_entity.vz).normalize();

    // let dotProduct_vel_pos = velocity_vec.dot(vectorToclosest_in_right_2);
    let dotProduct_vel_pos_right = vel_direction.dot(vectorToclosest_in_right_2);

    // if(dotProduct_vel_pos_right < -1  )
    // {
    //   console.log("id: ", capsule_entity.index, ", dotProduct_vel_pos_right: ", dotProduct_vel_pos_right);
    //   console.log("cur_position: ", cur_position, ", closest_in_right_2: ", closest_in_right_2);
    //   console.log(" \n\n ");
    // }
    ...
    // if(dotProduct_vel_pos_left < -1 )
    // {
    //   console.log("id: ", capsule_entity.index, ", dotProduct_vel_pos_left: ", dotProduct_vel_pos_left );
    //   console.log("cur_position: ", cur_position, ", closest_in_left_2: ", closest_in_left_2);
    //   console.log(" \n\n ");
    // }
    ...
    if(closest_in_right_2.length() != 0 && dotProduct_vel_pos_right > -1 )
    {
...
if(item.index == 1)
{
  // console.log("rotation: ", item.agent.rotation.z);
}
// console.log("id: ", item.index,", rotation: ", item.agent.rotation.z);
